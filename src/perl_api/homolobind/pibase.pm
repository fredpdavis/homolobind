...
homolobind::pibase - pibase table descriptions

=head1 DESCRIPTION

The pibase.pm perl library contains PIBASE table descriptions.
(much) trimmed down version of PIBASE's pibase.pm
...
package homolobind::pibase ;
use Exporter ;
use strict ;
use warnings ;

our @ISA = qw/Exporter/ ;
our @EXPORT_OK = qw/table_spec/ ;
